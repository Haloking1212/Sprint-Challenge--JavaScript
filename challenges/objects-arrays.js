...
const universities = [];
graduates.forEach(function (mail) {
...
const uni = [];
      graduates.forEach(function(uniSchool){
        uni.push(uniSchool.first_name + ' ' + uniSchool.university.includes('Uni'))
        return uni;
      });
